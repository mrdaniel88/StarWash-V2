...
export const Home = () => {
  ...
  return (
    <div className="container-fluid px-0">
      <div className="row text-center d-flex custom-home">
          ...
          <div id="carouselExampleControls" className="carousel slide pt-4" data-bs-ride="carousel">
            <div className="carousel-inner container" style={{ width: "75%", margin: "0 auto" }}>
              <div className="carousel-item active">
                <img src="https://img.freepik.com/foto-gratis/hombre-lavando-su-auto-garaje_1157-26072.jpg?w=1380&t=st=1686345106~exp=1686345706~hmac=60b081dbbfb91c247e1a913d9d7e38f57107d88f890ecb2ccc8b0ef6df099b8c" className="d-block w-100" alt="..." style={{ width: "100%", height: "100%", margin: "0 auto" }} />
              </div>
              ...
              <div className="carousel-item">
                <img src="https://img.freepik.com/fotos-premium/hombre-lavando-automovil-autoservicio-lavado-autos-lavadora-vehiculos-alta-presion-rocia-espuma_177415-8.jpg?w=1380" className="d-block w-100" alt="..." style={{ width: "100%", height: "100%", margin: "0 auto" }} />
              </div>
              <div className="carousel-item">
                <img src="https://img.freepik.com/fotos-premium/limpieza-automovil-detalles-automovil-tienda-cuidado-automovil_41043-2766.jpg?w=1380" className="d-block w-100" alt="..." style={{ width: "100%", height: "100%", margin: "0 auto" }} />
              </div>
              <div className="carousel-item">
                <img src="https://img.freepik.com/foto-gratis/cerrar-proceso-cuidado-automovil_23-2149193628.jpg?w=1380&t=st=1686346248~exp=1686346848~hmac=318635960e0dfbaff63216ec624c08ece27f5a5e6a8230a9ca366082bc46d56c" className="d-block w-100" alt="..." style={{ width: "100%", height: "100%", margin: "0 auto" }} />
              </div>
            </div>
        ...
        <div className="col-lg-5">
          <div className="card custom-home border-0 me-lg-5 pe-2" style={{ maxWidth: "18rem" }}>
      ...
      <div className="row">
        <div className="col-12">
          ...
          <div className=" d-flex" style={{ backgroundColor: "#24292e" }}>
            <div className="icons-containers card col-4 border-0 d-flex flex-column align-items-center mt-5">
         ...
         */}
            ...
            <div className="icons-containers card col-4 border-0 d-flex flex-column align-items-center mt-5" >
              ...
              <i class="icons fa-solid fa-hand-sparkles"></i>
              <div className="card-body">
            ...
            <div className="icons-containers card col-4 border-0 d-flex flex-column align-items-center mt-5" >
              ...
              <i class="icons fa-solid fa-umbrella-beach"></i>
              <div className="card-body">
