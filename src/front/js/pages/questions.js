      ...
      <div className="container" >
        ...
        <div className="accordion my-3 " style={{ color: '#24292e' }} id="accordionPanelsStayOpenExample">
          <div className="accordion-item">
            ...
            <div id="panelsStayOpen-collapseOneB" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOneB">
              <div className="accordion-body">
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="panelsStayOpen-headingTwoB">
              <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwoB" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                How long does it take for my seats and carpets to dry?
              </button>
            </h2>
            <div id="panelsStayOpen-collapseTwoB" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwoB">
              <div className="accordion-body">
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="panelsStayOpen-headingThreeB">
              <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThreeB" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                Do you remove seats?
              </button>
            </h2>
            <div id="panelsStayOpen-collapseThreeB" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThreeB">
              <div className="accordion-body">
        ...
        <div className="accordion  py-3  " style={{ color: '#24292e' }} id="accordionPanelsStayOpenExample">
          <div className="accordion-item">
            ...
            <div id="panelsStayOpen-collapseOneC" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOneC">
              <div className="accordion-body">
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="panelsStayOpen-headingTwoC">
              <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwoC" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                Do you do group washes?
              </button>
            </h2>
            <div id="panelsStayOpen-collapseTwoC" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwoC">
              <div className="accordion-body">
